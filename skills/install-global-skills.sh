...
echo ""
echo "如需从备份仓库恢复本地 skill："
echo "  git clone https://github.com/paninick/paninick-claude-config.git"
echo "  cp -r paninick-claude-config/skills/erp-verify ~/.claude/skills/"
echo "  cp -r paninick-claude-config/skills/knit-erp-workflow ~/.claude/skills/"
echo "  cp -r paninick-claude-config/skills/skill-registry ~/.claude/skills/"
